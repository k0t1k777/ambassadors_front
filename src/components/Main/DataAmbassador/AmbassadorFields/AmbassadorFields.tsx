...
export default function AmbassadorFields({ selectedItem }: AmbassadorFieldsProps) {
  ...
  const [currentWorkValue, setCurrentWorkValue] = useState(selectedItem?.current_work);
