...
export default function DataTable() {
  const initialData = [
    ...
    // Добавьте другие элементы в массив данных по мере необходимости
  ];
  ...
  const toggleDropdown = (index) => {
    const updatedDropdownStates = dropdownStates.map((state, idx) =>
  ...
  return (
    <div className="table__sending">
      ...
      {initialData.map((item, index) => (
        <div key={index} className="table__container-data">
          <div className="table__check table__th_size_s"></div>
